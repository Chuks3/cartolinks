...
const NavBar = () => {
    ...
    return (
        <nav className="bg-neutral-200 dark:bg-neutral-500">
            <div className="flex justify-between items-center py-[3px] mx-[30px] sticky top-[0] z-30">
                <div className="flex gap-[25px] items-center">
                    ...
                    <span className="flex gap-[20px] items-center">
                        ...
                        <p className="cursor-pointer">benevolentnimbobon</p>
                        <img className="cursor-pointer" src="https://img.icons8.com/?size=20&id=45330&format=png&color=000000" alt="icon" />
                    </span>
                </div>
                <div className="flex gap-[25px] items-center bg-gray-200 dark:bg-neutral-400 rounded-[10px] py-[5px] px-[10px] cursor-pointer">
                ...
                <div className="flex justify-between gap-[20px] items-center">
                    <span className="flex gap-[10px] items-center bg-[#D3D3D3] rounded-[10px] py-[5px] px-[10px] text-black cursor-pointer">
                        <img src="https://img.icons8.com/?size=25&id=TXu8dnb62RkC&format=png&color=000000" alt="icon" />
                        Gallery
                    </span>
                    <span className="flex gap-[10px] items-center bg-[#D3D3D3] rounded-[10px] py-[5px] px-[10px] text-black cursor-pointer">
                    ...
                    <img src="https://img.icons8.com/?size=25&id=49387&format=png&color=000000" className="bg-[#D3D3D3] rounded-[10px] py-[5px] px-[10px] cursor-pointer" alt="icon" />
                    <img src="https://img.icons8.com/?size=25&id=43884&format=png&color=000000" className="bg-[#D3D3D3] rounded-[10px] py-[5px] px-[10px] cursor-pointer" alt="icon" onClick={() => setTheme(theme === "light" ? "dark" : "light")} />
